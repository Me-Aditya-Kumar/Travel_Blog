...
echo $blog_date = $_POST['date'];
echo $blog_photo_url = $_POST['photo_url'];
echo $blog_description = $_POST['description'];

$sql = " INSERT INTO blog(blog_img,blog_title,blog_desc,blog_date) VALUES ('{$blog_photo_url}','{$blog_title}','{$blog_description}','{$blog_date}') ";
$result = mysqli_query($conn, $sql) or die("Query unsuccessful");
header("Location: https://localhost/blog.php");
mysqli_close($conn);
}
?>
<!DOCTYPE html>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="post-form" action="<?php $_SERVER["PHP_SELF"]; ?>" method="post" >
                            ...
                            <input required type="text" name="description" class="form-control" id="description" placeholder="Enter Facebook URL">
